  ...
  return (
    <main className="min-h-screen bg-rq-aurora flex items-center justify-center px-6 py-12">
      <div className="glass p-8 w-full max-w-md">
        ...
        <h1 className="font-display text-3xl font-black mb-2">Comece sua quest</h1>
        <p className="text-white/60 text-sm mb-6">Conta grátis em 30 segundos.</p>
        ...
        <div className="mt-6 text-sm text-white/60 text-center">
          Já tem conta? <Link href="/auth/login" className="text-rq-lime hover:underline">Entrar</Link>
        </div>
      </div>
    </main>
  );
