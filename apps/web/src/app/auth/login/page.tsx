  ...
  return (
    <main className="min-h-screen bg-rq-aurora flex items-center justify-center px-6">
      <div className="glass p-8 w-full max-w-md">
        ...
        <p className="text-white/60 text-sm mb-6">{t('auth.login.subtitle')}</p>
        ...
        <div className="mt-6 text-sm text-white/60 text-center">
          {t('auth.login.noAccount')} <Link href="/auth/register" className="text-rq-lime hover:underline">{t('auth.login.createFree')}</Link>
        </div>
      </div>
    </main>
  );
