  ...
  return (
    <main className="min-h-screen bg-rq-aurora flex items-center justify-center px-6">
      <div className="glass p-8 w-full max-w-md">
        ...
        <h1 className="font-display text-3xl font-black mb-2">Bem-vindo de volta</h1>
        <p className="text-white/60 text-sm mb-6">Entre para continuar sua quest.</p>
        ...
        <div className="mt-6 text-sm text-white/60 text-center">
          Não tem conta? <Link href="/auth/register" className="text-rq-lime hover:underline">Criar grátis</Link>
        </div>
      </div>
    </main>
  );
